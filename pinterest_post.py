...
def update_sheet(sheet_service, row_index, board_id, pin_id=None):
    # Update Status (K), Board ID (L), and Pin ID (M) columns
...
def get_all_boards(access_token):
    ...
    all_boards = []
    page_size = 250  # Pinterest API maximum page size limit
    page = 1
    max_pages = 10  # Increased max pages since we're using the correct page size
